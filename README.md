...
```bash
repo init -u https://github.com/Octavi-Testing-Org/platform_manifest.git -b 12.1

```
or to save bandwith and space 

```bash
repo init -u https://github.com/Octavi-Testing-Org/platform_manifest.git -b 12.1 --depth=1
```
